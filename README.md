...
* **Detailed 3D Vehicles**: Distinct tram, bus, metro and commuter-train bodies have articulated sections, windows, running gear and roof equipment. Models fade in between zoom 13 and 14 (previously 15–16), retaining real-world dimensions. The vehicle button in the map-view controls enables **Always show 3D vehicles**, including on the flat map, independently of map tilt; this preference persists. Below zoom 13, icons remain visible for readability.
